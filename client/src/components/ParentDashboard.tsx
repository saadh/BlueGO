...
const mockStudents = [
  { id: "1", name: "Emma Johnson", grade: "5", class: "A", gender: "female" as const, nfcLinked: true },
  { id: "2", name: "Noah Johnson", grade: "2", class: "B", gender: "male" as const, nfcLinked: false },
];
